 ...
 * + очень простой и _КРАТКИЙ_ API, ну надоели уже эти якобы простые api, после которых даже старый добрый 
 *   xhr кажется совершенством(да да, я про убогие промисы)
...
var ctx = service('https://simple.rulezz');
